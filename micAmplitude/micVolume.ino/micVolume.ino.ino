...
const int sampleWindow = 33;                              // Sample window width in mS (50 mS = 20Hz)
unsigned int sample;
...
//   display.display();                                     //show title
  ...
  pinMode(2, OUTPUT); 
  pinMode(3, OUTPUT); 
  pinMode(4, OUTPUT); // dig pin 2 3 4 for led grounding
...
void loop() 
{
  digitalWrite(12, HIGH);
   ...
   Serial.println(peakToPeak/10);
   analogWrite(2, peakToPeak/6);
//   analogWrite(2, 0);
//  analogWrite(3,255);
//  analogWrite(4,255);
